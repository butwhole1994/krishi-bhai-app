    ...
    return (
        <Box>
            ...
            <Button
                ...
                onPress={() => {
                    navigation.navigate('3rd'); // SKIP 버튼 클릭 시 '3rd' 화면으로 이동
                }}
            >
            ...
            <Center className="p-3">
                <Heading size="3xl">Let me know your crops!</Heading>
            </Center>
            ...
            <Center>
                <Image
                    ...
                    size="2xl"
                    source={require("@/resources/images/onBoarding/crop_image.jpg")}
                    alt="crop_image"
                />
            </Center>
            ...
            <VStack className="p-4 border-outline-300" space="xl">
                ...
                <Controller
                    ...
                    name="my_crop_name"   // 이 필드의 이름 지정 (최종 폼 데이터의 key)
                    rules={{required: "Crop Name must be set"}} // 유효성 검사 규칙
                    render={({field: {onChange, onBlur, value}, fieldState: {error}}) => (
                        // FormControl 컴포넌트로 입력 필드 및 에러 메시지 감싸기
                        <FormControl isInvalid={!!error}>
                            <FormControlLabel>
                                <FormControlLabelText>Crop Name</FormControlLabelText>
